...
<head>
    ...
    <title>CafThé - Gestion vendeurs</title>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary">Liste des vendeurs</h4>
                </div>
                <div class="mt-3 pl-3">
                    <a href="index.php?action=add_vendeur" class="btn btn-secondary btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fa-solid fa-plus"></i>
                                        </span>
                        <span class="text">Ajouter un vendeur</span>
                    </a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                       <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                            {foreach from=$vendeur item=vendeur}
                                <tr>
                                    <td>{$vendeur.Nom_vendeur|escape}</td>
                                    <td>{$vendeur.Prenom_vendeur|escape}</td>
                                    <td>{$vendeur.Role|escape}</td>
                                    <td>
