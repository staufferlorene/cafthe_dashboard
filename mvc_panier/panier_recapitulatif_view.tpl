        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary">Récapitulatif et encaissement</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                            <h5 class="m-0 mb-3 mt-3 font-weight-bold text-primary">Informations produit(s)</h5>
                            <thead>
                            <tr>
                                <th>Produit</th>
                                <th>Prix HT / unité</th>
                ...
                <div class="row pl-4 pr-4">
                    <div class="col-md-6">
                        ...
                        <p>Nom : {$clientSession.nom|escape}</p>
                        <p>Prénom : {$clientSession.prenom|escape}</p>
                        <p>Adresse : {$clientSession.adresse|escape}</p>
                    </div>
                </div>
                    <div class="pl-4 pr-4 mt-3 mb-3 text-center">
                        <a href="index.php?action=client_panier" class="btn btn-secondary mr-2">Retour</a>
                        <a href="index.php?action=paiement_panier" class="btn btn-success mr-2">Paiement CB</a>
                        <a href="index.php?action=paiement_panier" class="btn btn-success">Paiement espèce</a>
                    </div>
                </div>
                </div>
            </div>
